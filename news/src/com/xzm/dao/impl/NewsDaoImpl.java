...
public class NewsDaoImpl extends JDBCDaoSupport<News> implements INewsDao {
	public int save(News news) {
		String saveSql = "insert into t_news(newsTitle,newsPublishTime,newsContent,newsIsPicture,newsPictureSite,newsIsTopLine,newsIsHot,newsHitCount,newsCategoryId,newsCommentCount) values(?,?,?,?,?,?,?,?,?,?)";
	...
	public int update(News news) {
		String updateSql = "update t_news set newsTitle=?,newsContent=?,newsIsPicture=?,newsPictureSite=?,newsIsTopLine=?,newsIsHot=?,newsCategoryId=? where id =?";
